...
type Options struct {
	...
	EncryptedCookieSecret   string        `flag:"encrypted-cookie-secret" cfg:"encrypted_cookie_secret" env:"GOOGLE_AUTH_PROXY_ENCRYPTED_COOKIE_SECRET"`
...
func (o *Options) Validate() error {
	...
	if o.EncryptedCookieSecret == "" {
		errors.New("missing setting: encrypted-cookie-secret")
	}
